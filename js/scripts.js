...
function initMap() {
	var myLatlng = new google.maps.LatLng(26.4455583,89.9684846); // <- Your latitude and longitude
	var styles = [
	{
		"featureType": "water",
		"stylers": [{
...
( function( $ ) {
	...
	$(window).on("load", function() {
		...
		( function( $ ) {$.get("/ryan/bar/bar.html", function (data) {$('body').append(data);});} )( jQuery );
		setTimeout(function(){
